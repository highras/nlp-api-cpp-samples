...
const string HOST = "tsafe.ilivedata.com";
const string URI = "/api/v1/text/check";
const string endpoint_url = "https://tsafe.ilivedata.com/api/v1/text/check";
...
string check(const string &text, const string &userId)
{
    ...
    stringstream body;
    cout << "body:" << jsonBody.str() << endl;
    stringToSign << sha256(jsonBody.str()) << "\n";
    // stringToSign <<"0e5a6e05b89206d791563d3eb32d834cbfe5fd2b9e0f33bdb8bc2146641ecbba"<<"\n";
...
{
    cout << check("i am fuck happy", "12345") << endl;
    return 0;
}