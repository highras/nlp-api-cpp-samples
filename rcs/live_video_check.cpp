...
const string URI = "/api/v1/livevideo/check/submit";
const string endpoint_url = "https://vsafe.ilivedata.com/api/v1/livevideo/check/submit";
...
{
    string video_url = "LIVE_VIDEO_URL";
