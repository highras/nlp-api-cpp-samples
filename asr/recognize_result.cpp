...
const string URI = "/api/v1/speech/recognize/result";
...
string get_result(const string &taskId)
{

    stringstream queryBodyJsonStream;
    queryBodyJsonStream << "{\"taskId\": \"" << taskId << "\"}";
...
{
    string taskId = "us_b5d0c173-96e8-47b1-879c-d9444512ea12_1615195987742";

    cout << get_result(taskId) << endl;
