...
const string URI = "/api/v1/speech/recognize";
...
string recognize(const string &audio, const string &languageCcode, const string &userId, bool profanityFilter)
{
    ...
    queryBodyJsonStream << "{\"languageCode\": \"" << languageCcode << "\", \"profanityFilter\": " << profanityFilterStr << ", \"config\": {\"codec\": \"" << codeC << "\", \"sampleRateHertz\": " << sampleRateHertz << "}, \"audio\": \"" << audio << "\", \"userId\": \"" << userId << "\"}";
