...
string recognize(const string &audio, const string &languageCcode, const string &userId)
{
    ...
    queryBodyJsonStream << "{\"languageCode\": \"" << languageCcode << "\", \"config\": {\"codec\": \"" << codeC << "\", \"sampleRateHertz\": " << sampleRateHertz << "}, \"audio\": \"" << audio << "\", \"userId\": \"" << userId << "\"}";
...
int main(int argc, char *argv[])
{
    ...
    cout << recognize(audioBase64, "zh-CN", "12345678") << endl;
    cout << recognize(audioBase64, "zh-CN", "12345678") << endl;
