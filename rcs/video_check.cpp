...
const string URI = "/api/v1/video/check/submit";
const string endpoint_url = "https://vsafe.ilivedata.com/api/v1/video/check/submit";
...
string check(const string &video_url, int type, const string &userId)
{
...
{
    string video_url = "http://edge.ivideo.sina.com.cn/34463529803.mp4?KID=sina,viask&Expires=1597852800&ssig=6po29lqbTn&reqid=";
    cout << check(video_url, 1, "12345") << endl;
    return 0;
}
